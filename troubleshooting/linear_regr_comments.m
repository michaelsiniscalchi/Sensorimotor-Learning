function [ output ] = linear_regr_comments ( signal, t, event, eventTime, trialSubset, params)
% % linear_regr %
...
%         end
        ...
        %***terms matrix incorrectly defined (response var omitted: should be a column of zeros.)
