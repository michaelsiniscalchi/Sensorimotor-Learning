%%% screenROIs_batch (script)
%
% PURPOSE: Creates a figure for each ROI imaged in experiments from each subject specified.
%               Displays image of local mean projection and plots F(t).
%
% AUTHOR: MJ Siniscalchi 190219 for longitudinal application; edited 190731 for batch processing in
