function fig = plot_psth(input,tlabel,xtitle)
%%% plot_psth %
%PURPOSE:   Plot bootstrapped cellular fluorescence time-locked to behavioral event.
%               -please note that this is NOT a PSTH. ***FUTURE filename/fcn change!
